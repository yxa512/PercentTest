package com.yxa512.tool.recycleview;
...
/**
 * Created by yangsh on 2016/5/22.
 */
public class DividerLinearItemDecoration extends RecyclerView.ItemDecoration {
    ...
    //分割线与左右边框的距离，默认0px
    private int mMargnLeftAndRight=0;
    ...
    public DividerLinearItemDecoration(Context context, int orientation, int dividerHeight, int dividerColor, int mar) {
        this(context, orientation);
        mDividerHeight = dividerHeight;
        mMargnLeftAndRight=mar;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(dividerColor);
        mPaint.setStyle(Paint.Style.FILL);
    }
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent) {
        final int left = parent.getPaddingLeft()+mMargnLeftAndRight;
        final int right = parent.getMeasuredWidth() - parent.getPaddingRight()-mMargnLeftAndRight;
